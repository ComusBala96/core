 ...
 * Success modal
 */
export function success(op: SweetAlertOptions = {}): Promise<SweetAlertResult<any>> {
 ...
 * Error modal
 */
export function error(op: SweetAlertOptions = {}): Promise<SweetAlertResult<any>> {
 ...
 * Warning modal
 */
export function warning(op: SweetAlertOptions = {}): Promise<SweetAlertResult<any>> {
 ...
 * Info modal
 */
export function info(op: SweetAlertOptions = {}): Promise<SweetAlertResult<any>> {
 ...
 * Question modal
 */
export function question(op: SweetAlertOptions = {}): Promise<SweetAlertResult<any>> {
 ...
 * Confirmation modal
 */
export function confirm(op: SweetAlertOptions = {}): Promise<SweetAlertResult<any>> {
    return fire({
        icon: 'question',
 ...
 * Loading modal
 */
export function loading(op: SweetAlertOptions = {}): Promise<SweetAlertResult<any>> {
    return fire({
 ...
 * Toast notification
 */
export function tost(op: SweetAlertOptions = {}): Promise<SweetAlertResult<any>> {
    return fire({
        toast: true,
 ...
 */
export function tostSuccess(op: SweetAlertOptions): Promise<SweetAlertResult<any>> {
 ...
 */
export function tostError(op: SweetAlertOptions = {}): Promise<SweetAlertResult<any>> {
 ...
 */
export function tostWarning(op: SweetAlertOptions = {}): Promise<SweetAlertResult<any>> {
 ...
 */
export function tostInfo(op: SweetAlertOptions = {}): Promise<SweetAlertResult<any>> {
 ...
 * Validation error
 */
export function validationErrors(errors: Record<string, string[] | string>, op: SweetAlertOptions = {}): Promise<SweetAlertResult<any>> {
 ...
 * XHR Error
 */
export function xhrError(op: SweetAlertOptions = {}): Promise<SweetAlertResult<any>> {
    return error(op);
}
