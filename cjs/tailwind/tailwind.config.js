...
const colors_1 = tslib_1.__importDefault(require("tailwindcss/colors"));
exports.default = {
    darkMode: 'class',
    theme: {
        container: {
        ...
        extend: {
            colors: {
                ...
                black: {
                    DEFAULT: colors_1.default.black,
                    1: '#1C2434',
                    2: '#010101',
                },
                red: {
            ...
            animation: {
                'scroll-breakingNews': 'scroll 60s linear infinite',
                'scroll-breakingNews-sm': 'scroll 65s linear infinite',
                slide: 'slide 1s infinite linear',
